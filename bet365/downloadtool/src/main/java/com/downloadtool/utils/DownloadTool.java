...
public class DownloadTool {
    ...
    public static void download(final Activity activity, final String url) {
        ...
        // 2.配置Builder
        // 配置下载文件保存的文件夹
        builder.configFileDownloadDir(activity.getExternalCacheDir().getAbsolutePath() + File.separator + "FileDownloader");
        ...
        View view = View.inflate(activity,R.layout.ui_download_progress,null);
