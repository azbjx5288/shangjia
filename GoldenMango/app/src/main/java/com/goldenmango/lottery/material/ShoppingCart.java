...
import com.goldenmango.lottery.data.Balls;
...
public class ShoppingCart {
    ...
    private LucreMode lucreMode = LucreMode.fromCode(GoldenMangoApp.getUserCentre().getLucreMode()); /** 当前金额模式 */
    ...
    private int prizeGroup = GoldenMangoApp.getUserCentre().getPrizeGroup();    /** 奖金组 **/
    ...
    public void setPlanBuyRule(int multiple, int tracenum, boolean stopOnWin) {
        ...
        this.lucreMode = LucreMode.fromCode(GoldenMangoApp.getUserCentre().getLucreMode());
        this.prizeGroup = GoldenMangoApp.getUserCentre().getPrizeGroup();
        ruleCount();
        codePurify();
        ordersPurify();
    }
