...
import com.goldenmango.lottery.base.CrashHandler;
 ...
 */
public class GoldenMangoApp extends Application {
    public static final boolean SERVER_TYPE = true;//true:正式服；false：测试服
    private static GoldenMangoApp sApp;
    ...
    public void onCreate() {
        ...
        if (SERVER_TYPE) {
            baseUrl = "http://jinmg8888.com";  // 正式服
        } else {
            baseUrl = "http://api.jinmgonline.com";//测试服
        }
    ...
    public static GoldenMangoApp getInstance() {
        return sApp;
    }
