...
import com.goldenmango.lottery.util.DownPicUtil;
...
//        initImmersionBarEnabled();
    ...
    void callCard(String path) {
        saveImageInto(GoldenMangoApp.getInstance().getBaseUrl() + path);
    }
    ...
    void onCardNeverAsk() {
        ToastUtils.showShortToast(getActivity(), "若想使用支付，请到“设置-应用程序-金芒果”中开启读写SD卡权限");
    }
