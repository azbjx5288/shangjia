package com.goldenmango.lottery.material;
...
public class ConstantInformation {
    ...
    static {
        ...
        //芒果分分彩
        sLotteryLogo.put("MGFFC", new int[]{R.drawable.mgffc, R.drawable.mgffc});
        //芒果11选5
        sLotteryLogo.put("MG115", new int[]{R.drawable.mg11x5, R.drawable.mg11x5});
        //芒果极速PK10
        sLotteryLogo.put("MGPK10", new int[]{R.drawable.mgjspk10, R.drawable.mgjspk10});
        //芒果极速3D
        sLotteryLogo.put("MG3D", new int[]{R.drawable.mgjs3d, R.drawable.mgjs3d});
        //芒果五分彩
        sLotteryLogo.put("MG5FC", new int[]{R.drawable.mg5fc, R.drawable.mg5fc});
        // 上海时时乐
        ...
        //芒果三分彩
        sLotteryLogo.put("MG3FC", new int[]{R.drawable.mgsfc, R.drawable.mgsfc});
        // 芒果快三分分彩
        sLotteryLogo.put("MGK3", new int[]{R.drawable.mgks, R.drawable.mgks});
    ...
    public static RecordTime getLasttime(String former, String  currenttime) {
        RecordTime recTime = new RecordTime();
        try {
            Date d1 = df.parse(former);
    ...
    public static RecordTime getLasttime2(String former, String  currenttime) {
        RecordTime recTime = new RecordTime();
        try {
            Date d1 = df.parse(former);
            Date d2 = df.parse(currenttime);
    ...
    public static String gatherInfo(Activity activity, PayMoneyCommand command) {
        ...
        return "手机IMEI号：" + imei + ",\n手机IESI号：" + iesi + ",\n手机型号：" + android.os.Build.MODEL +
                ...
                .VERSION_CODE + ",\nUserID：" + GoldenMangoApp.getUserCentre().getUserID() + "," +
