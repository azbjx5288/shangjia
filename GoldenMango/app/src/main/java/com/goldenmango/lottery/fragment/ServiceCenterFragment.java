...
import com.goldenmango.lottery.data.ServiceParam;
import com.goldenmango.lottery.data.UserInfo;
import com.goldenmango.lottery.material.ImageFilePath;
...
public class ServiceCenterFragment extends BaseFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        userInfo = GoldenMangoApp.getUserCentre().getUserInfo();
        if (GoldenMangoApp.getNetStateHelper().isConnected()) {
...
//        webView.loadUrl("http://s3.myapple888.com/index/app?companyId=70722528&style=default&mode=4&token="+ userjson);
        webView.loadUrl(" http://yafuweb.4385nt.com/mobile.php?userid=86872&name=money001&platform=7");
