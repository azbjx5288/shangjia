...
import com.goldenmango.lottery.data.BackToken;
import com.goldenmango.lottery.data.BindCardDetail;
import com.goldenmango.lottery.data.CardDetailCommand;
import com.goldenmango.lottery.data.ReviseCommand;
import com.goldenmango.lottery.data.UserInfo;
import com.goldenmango.lottery.data.UserInfoCommand;
import com.goldenmango.lottery.data.WithdrawCommand;
...
//    Button submit;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        money.setText(String.format("%.4f", GoldenMangoApp.getUserCentre().getUserInfo().getAbalance()));
        loadInfo();
...
//                RecordTime intendedLockAt = ConstantInformation.getLasttime2( checkCard.getIntendedWithdrawalAt(),sdf.format(new Date()));
//                Log.e(TAG, "Day-> " + intendedLockAt.getDay() + "  Hour-> " + intendedLockAt.getHour() + "  Minute-> " + intendedLockAt.getMinute() + "  Second-> " + intendedLockAt.getSecond());
