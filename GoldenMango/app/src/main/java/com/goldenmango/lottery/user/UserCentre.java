package com.goldenmango.lottery.user;
...
public class UserCentre {
    ...
    public boolean isLogin() {
        return session != null && GoldenMangoApp.getUserCentre().getUserName() != null && getUserInfo() != null;
    }
    ...
    public String getKeyApiKey() {
        if (GoldenMangoApp.SERVER_TYPE) {
            return "505b2c0b58fff48635c6c955ced91a2b";//"dad4dd748f43145581a3da7jsh4bf029";
        } else {
