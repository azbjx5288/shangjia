...
import com.goldenmango.lottery.data.MethodType;
import com.goldenmango.lottery.game.Game;
import com.goldenmango.lottery.game.GameConfig;
import com.goldenmango.lottery.game.MenuController;
import com.goldenmango.lottery.game.OnSelectedListener;
import com.goldenmango.lottery.material.ShoppingCart;
import com.goldenmango.lottery.material.Ticket;
import com.goldenmango.lottery.pattern.TitleTimingView;
...
public class GameFragment extends BaseFragment implements OnSelectedListener, TableMenu.OnClickMethodListener {
    ...
    private void loadMethodFromXml() {
        String methodTypeKey = "game_config_methodtype_" + GoldenMangoApp.getUserCentre().getUserID() + "_" + lottery.getId();
        String methodTypeJson = Preferences.getString(getContext(), methodTypeKey, null);

        String methodKey = "game_config_method_" + GoldenMangoApp.getUserCentre().getUserID() + "_" + lottery.getId();
    ...
    private RestCallback restCallback = new RestCallback<ArrayList<?>>() {
        ...
        public boolean onRestComplete(RestRequest request, RestResponse response) {
            if (request.getId() == ID_METHOD_LIST) {
                ...
                if (methodListRecord != null && game == null) {
