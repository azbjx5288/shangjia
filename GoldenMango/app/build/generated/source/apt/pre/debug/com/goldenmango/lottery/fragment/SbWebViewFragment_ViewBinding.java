...
public class SbWebViewFragment_ViewBinding implements Unbinder {
  private SbWebViewFragment target;

  @UiThread
  public SbWebViewFragment_ViewBinding(SbWebViewFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SbWebViewFragment target = this.target;
